...
public class Server {
	...
	public static void main(String[] args) throws SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException{
		ConnectionImpl srvr = new ConnectionImpl(7878);
		Log log = new Log();
	    log.setLogName("Server");
		try {
			ServerThread srvrThread;
			while (true){
			srvrThread = new ServerThread(srvr.accept());
			srvrThread.run();
...
//		interpretInput("getAppointmentsByOwner#Vegard-vegard.holter@gmail.com-vegaholt");
	...
	public static String interpretInput(String input) throws SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException{
		...
		//Finner metodeindex
		// might want to use following : int commandIndex = commandList.indexOf(command);
		int commandIndex = 0;
